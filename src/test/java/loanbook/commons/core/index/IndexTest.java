package loanbook.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthLoanIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthLoanIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthLoanIndex.equals(Index.fromZeroBased(4)));
        ...
        assertFalse(fifthLoanIndex.equals(Index.fromOneBased(1)));
    }
}
