 ...
 */
public class HelpCommandSystemTest extends LoanBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_LOAN.getOneBased());
